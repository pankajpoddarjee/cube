...
/* *****************************************  USER ROUTES  **************************************************** */
//USERS ROUTES
$route['login'] = "user/UserAuth/login";
$route['signup'] = "user/UserAuth/signup";
$route['user/login'] = "user/UserAuth/login";
$route['user/signup'] = "user/UserAuth/signup";
...
//Project
$route['admin/project'] = "admin/ProjectController/project";
$route['admin/addProject'] = "admin/ProjectController/addProject";
$route['admin/saveProject'] = "admin/ProjectController/saveProject";
$route['admin/editProject/(:any)'] = "admin/ProjectController/editProject/$1";
$route['admin/deleteProject/(:any)'] = "admin/ProjectController/deleteProject/$1";

//Jobs
$route['admin/project/(:any)/jobs'] = "admin/ProjectController/jobs/$1";
$route['admin/project/(:any)/addJobs'] = "admin/ProjectController/addJobs/$1";
$route['admin/project/(:any)/editJobs/(:any)'] = "admin/ProjectController/editJobs/$1/$2";
$route['admin/project/(:any)/saveJobs'] = "admin/ProjectController/saveJobs/$1";
$route['admin/project/(:any)/deleteJobs/(:any)'] = "admin/ProjectController/deleteJobs/$1/$2";

//Jobs Detail
$route['admin/project/(:any)/jobs/(:any)/estimate'] = "admin/ProjectController/estimate/$1/$2";
