                        ...
                        <form method="post" action="<?php echo base_url('user/signup'); ?>">
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control bg-transparent" name="name" id="name" placeholder="Your Name" value="<?=set_value('name')?>">
                                    <label for="name">Your Name</label>
                                    <?php $name_err = form_error('name'); if(isset($name_err)) { ?>
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                    <input type="text" class="form-control bg-transparent" name="mobile" id="mobile" placeholder="Your Mobile" value="<?=set_value('mobile')?>">
